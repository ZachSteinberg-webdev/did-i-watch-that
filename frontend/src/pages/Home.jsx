		...
		<>
			...
			<div id='landing-page'>
				<div className='landing-header'>
					<h1 className='landing-header-text'>&#x1F914; Did I Watch That?!?! &#x1F9D0;</h1>
					<img
				...
				<div className='landing-text'>
					<p>
						Keep track of the TV shows you&apos;ve watched. Never find yourself wondering which season or episode you
						last watched.
					</p>
				</div>

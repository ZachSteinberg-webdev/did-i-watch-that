...
export default function Tracker(){
	...
	// -------------------------------------------------------------------------------------------------
	const updateEpisodeModalCloseButton=(button)=>{useUpdateEpisodeModalCloseButton(
	...
	// -------------------------------------------------------------------------------------------------
	const handleShowAddInstructionsModalOpen=()=>{useHandleShowAddInstructionsModalOpen(
		setTrackerInstructionsShowAddModalOpen,
		makeTrackerPageInert,
		focusActiveModalCloseButton
	)};
	const handleShowAddInstructionsModalClose=()=>{useHandleShowAddInstructionsModalClose(
		setTrackerInstructionsShowAddModalOpen,
		makeTrackerPageInert,
		focusActiveElement,
		activeElement
	)};
	const handleTrackedShowsInstructionsModalOpen=()=>{useHandleTrackedShowsInstructionsModalOpen(
		setTrackerInstructionsTrackedShowsModalOpen,
		makeTrackerPageInert,
		focusActiveModalCloseButton
	)};
	const handleTrackedShowsInstructionsModalClose=()=>{useHandleTrackedShowsInstructionsModalClose(
		setTrackerInstructionsTrackedShowsModalOpen,
		makeTrackerPageInert,
		focusActiveElement,
		activeElement
	)};
	const handleTrackedShowInstructionsModalOpen=()=>{useHandleTrackedShowInstructionsModalOpen(
		setTrackerInstructionsTrackedShowModalOpen,
		makeTrackerPageInert,
		focusActiveModalCloseButton
	)};
	const handleTrackedShowInstructionsModalClose=()=>{useHandleTrackedShowInstructionsModalClose(
		setTrackerInstructionsTrackedShowModalOpen,
		makeTrackerPageInert,
		focusActiveElement,
		activeElement
	)};
	const handleTrackedShowDetailsModalOpen=()=>{useHandleTrackedShowDetailsModalOpen(
		setTrackedShowDetailsModalOpen,
		makeTrackerPageInert,
		focusShowDetailsModalCloseButton
	)};
	const handleTrackedShowDetailsModalClose=()=>{useHandleTrackedShowDetailsModalClose(
		setTrackedShowDetailsModalOpen,
		makeTrackerPageInert,
		focusActiveElement,
		activeElement
	)};
	const handleEpisodeDetailsModalOpen=()=>{useHandleEpisodeDetailsModalOpen(
		setTrackedShowEpisodeDetailsModalOpen,
		makeTrackerPageInert,
		setEpisodeModalOpenButtonClicked
	)};
	const handleEpisodeDetailsModalClose=()=>{useHandleEpisodeDetailsModalClose(
	...
	// -------------------------------------------------------------------------------------------------
	const handleShowSubmit=(e)=>{useHandleShowSubmit(
		e,
		setShowAddShowFormSpinner,
		setShowData,
		navigate
	)};
	const handleAddedShowSubmit=(e)=>{useHandleAddedShowSubmit(
		e,
	...
	const handleTrackedShowDelete=(e)=>{useHandleTrackedShowDelete(
		e,
		setShowTrackedShowsSpinner,
		user,
		trackedShow,
	...
	const handleTrackedShowsListSort=(e)=>{useHandleTrackedShowsListSort(
		e,
		setShowTrackedShowsSpinner,
		user,
		setTrackedShows,
	...
	const handleShowLoad=(e)=>{useHandleShowLoad(
		e,
		trackedShow,
	...
	const handleToggleEpisodeWatched=(e)=>{useHandleToggleEpisodeWatched(
		e,
		user,
		setWatchedEpisodes,
		watchedEpisodes,
	...
	const handleToggleSeasonWatched=(e)=>{useHandleToggleSeasonWatched(
		e,
		user,
		trackedShow,
		setWatchedEpisodes,
	...
	const handleEpisodeDetailsButtonClick=(e)=>{useHandleEpisodeDetailsButtonClick(
		e,
		setHoveredEpisodeDetails,
		handleEpisodeDetailsModalOpen,
		navigate
	)};
	const handleShowDetailsButtonClick=(e)=>{useHandleShowDetailsButtonClick(
		e,
		sanitizeHtml,

...
export default function Tracker() {
  ...
  const [trackedShowDetailsModalOpen, setTrackedShowDetailsModalOpen] =
    useState(false);
  const [
    trackedShowEpisodeDetailsModalOpen,
    setTrackedShowEpisodeDetailsModalOpen,
  ] = useState(false);
  const [episodeModalOpenButtonClicked, setEpisodeModalOpenButtonClicked] =
    useState(false);
  ...
  const handleEpisodeDetailsButtonClick = (e) => {
    useHandleEpisodeDetailsButtonClick(
      e,

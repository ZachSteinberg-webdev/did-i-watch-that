...
export default function Dashboard(){
	...
	const handleUserChangeSubmit=(e)=>{useHandleUserChangeSubmit(e, name, email, oldPassword, newPassword, setUser)};
		...
		<>
			...
			<div id='dashboard-page'>
				...
				<form id='user-update-form' onSubmit={handleUserChangeSubmit}>
					...
					<button id='user-update-button' type='submit'>Update</button>
				</form>
				<div className='user-tracked-shows-list'>
				</div>
			</div>
			<Footer/>
		</>

...
export default function Dashboard() {
	...
	const handleUserChangeSubmit = (e) => {
		useHandleUserChangeSubmit(e, name, email, oldPassword, newPassword, setUser);
	};
	useEffect(() => {
	...
	return (
		<>
			...
			<div id='dashboard-page'>
				...
				<small className='dashboard-text-extra-small'>You can update your username and/or email address below.</small>
				<small className='dashboard-text-extra-small'>
					To update your password, enter your old password and a new password. Otherwise, leave both fields empty.
				</small>
				<form
					id='user-update-form'
				...
				>
					<div className='form-inputs'>
						<div className='form-group-one'>
							<small className='dashboard-text-small'>You can update your username and/or email address below.</small>
							<input
								type='text'
								placeholder='Name'
								value={name}

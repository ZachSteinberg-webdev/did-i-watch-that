...
export default function TrackedShowsSection({
	...
	return(
		<>
			...
			/>
			<form className='tracker-tracked-shows-list-sort-form' onSubmit={handleTrackedShowsListSort}>
				<button className='tracker-tracked-shows-list-sort-button eligible-click-element' type='submit'>
				Sort alphabetically
				</button>
				<button className='tracker-tracked-shows-list-sort-button-small eligible-click-element' type='submit'>
				Sort A→Z
				</button>
			</form>
			<div className='tracker-tracked-shows-list-container-wrapper' tabIndex='-1' onKeyUp={handleKeyUp}>
				{showTrackedShowsSpinner && <Spinner spinnerClassName={'tracked-shows-spinner'}/>}
				<div className='tracker-tracked-shows-list-container' tabIndex='-1'>
					{trackedShows===undefined && <Spinner/>}
					{(trackedShows!==undefined && trackedShows.length===0) ?
						<>
							<p id='tracker-tracked-shows-list-header'>
						...
						<>
							{trackedShows!==undefined && trackedShows.map((trackedShow, index)=>{
								return(
									<ShowButtonFormAndDeleteForm
										showButtonFormAndDeleteFormClassName={'tracker-tracked-show-list-button-and-delete-button-wrapper'}

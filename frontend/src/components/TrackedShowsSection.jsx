...
export default function TrackedShowsSection({
  ...
  return (
    <>
      ...
      >
        {showTrackedShowsSpinner && (
          <Spinner spinnerClassName={"tracked-shows-spinner"} />
        )}
                      ...
                      <div className="tracker-tracked-show-list-button-and-delete-button-container">
                        <ShowButtonForm
                          ...
                          infoButtonSvgClassName={
                            "show-list-details-open-button-svg"
                          }
                          infoButtonPathClassName={
                            "show-list-details-open-button-path"
                          }
                        ...
                        <ShowButtonDeleteForm
                          ...
                          showButtonDeleteClassName={
                            "show-list-delete-button eligible-click-element"
                          }

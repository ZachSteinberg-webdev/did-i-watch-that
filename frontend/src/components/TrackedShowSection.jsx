        ...
        <div className="tracker-tracked-show-list-container" tabIndex="-1">
          ...
          {trackedShow.showName ? (
              ...
              <div className="tracked-show-seasons">
                {trackedShowSeasons[0] &&
                  trackedShowSeasons.map((trackedShowSeason, seasonIndex) => {
                    return (
                      <Fragment
                        key={`season-row-fragment-${trackedShowSeason.seasonNumber}`}
                      >
                        <div
                        ...
                        >
                          ...
                          >
                            {trackedShowSeason.episodeObjectIds.map(
                                ...
                                return (
                                  ...
                                  >
                                    <Tippy
                                      ...
                                      content={
                                        <div>
                                          <p className="tippy-title">
                                            Episode Title:
                                          </p>
                                          <p className="tippy-episode-title">
                                    ...
                                    >
                                      <EpisodeButtonForm
                                        ...
                                        episodeButtonFormClassName={
                                          "tracked-show-season-episode-container"
                                        }
                                        ...
                                        episodeButtonClassName={
                                          ...
                                          (watchedEpisodes.includes(episode._id)
                                            ? "watched"
                                            : "unwatched")
                                        }
                                        episodeButtonId={`tracked-show-season-episode-button-${episode._id}`}
                                        episodeButtonType={"submit"}
                                        episodeButtonValue={JSON.stringify(
                                          episode,
                                        )}
                                        infoButtonDummyClassName={
                                          "tracked-show-episode-details-dummy-button"
                                        }
                                        ...
                                        infoButtonFontColor={
                                          "var(--svg-font-color-info-button-details)"
                                        }
                                        infoButtonSvgClassName={
                                          "tracked-show-episode-details-open-button-svg"
                                        }
            ...
            !showTrackedShowSpinner && (
              <div className="no-show-selected-text-container">
                <div className="no-show-selected-text">
                  Click on a show from your list of tracked shows to start
                  tracking it.
                </div>
              </div>
            )

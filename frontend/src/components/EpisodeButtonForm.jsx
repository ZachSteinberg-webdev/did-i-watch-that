...
const EpisodeButtonForm = forwardRef(function EpisodeButtonForm(props, ref) {
	...
	return (
		...
		>
			...
			>
				<InfoButtonDummy infoButtonDummyClassName={'tracked-show-episode-details-dummy-button'} />
				<div className={episodeButtonInnerDivClassName}>{episodeNumber ? `Episode ${episodeNumber}` : 'Special'}</div>
				<InfoButton

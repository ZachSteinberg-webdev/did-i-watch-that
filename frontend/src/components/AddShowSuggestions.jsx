...
export default function AddShowFormSuggestions({ showData, handleAddedShowSubmit, handleShowDetailsButtonClick }) {
	return showData && showData.length === 0 ? (
		<p className='add-show-results-header'>Sorry! No shows were found using that search term. :(</p>
	) : (
		<>
			{showData &&
				showData.map((show, index) => {
					return (
						<ShowButtonForm
							...
							showButtonClassName={'add-show-result-button eligible-click-element'}
							...
							showButtonOuterDivClassName={'add-show-result-show-name-and-premiere-date-container'}
							showButtonInnerDivClassName={'add-show-result-show-name'}
							showButtonShowName={show.show.name}
							showButtonPremiereDateClassName={'add-show-result-show-premiere-date'}
							showButtonPremiereDateSmallClassName={'add-show-result-show-premiere-date-small'}
							showButtonPremiereDate={show.show.premiered}
							infoButtonClassName={'add-show-result-details-open-button eligible-click-element'}
							...
							infoButtonSvgClassName={'add-show-result-show-details-open-button-svg'}
							infoButtonPathClassName={'add-show-result-details-open-button-path'}

...
export default function ShowButtonForm({
	...
	return(
		<form className={showFormClassName} id={showFormId} onSubmit={showFormOnSubmit} key={showFormKey}>
			<button
			...
			>
				...
				<div className={showButtonOuterDivClassName}>
					...
					<small className={showButtonPremiereDateClassName}>
						Premiered: {(showButtonPremiereDate && new Date(showButtonPremiereDate).toLocaleDateString()) || "unknown"}
					</small>
					<small className={showButtonPremiereDateSmallClassName}>
						{(showButtonPremiereDate && new Date(showButtonPremiereDate).getFullYear()) || "unknown"}
					</small>
				</div>
				<InfoButton

...
export default function Header(){
	...
	const handleDarkModeToggle=(e)=>{useHandleDarkModeToggle(e, darkMode, setDarkMode)};

	useEffect(()=>{useGetInitialDarkModePreference();},[]);

	const navDropdown = document.querySelector('#nav-dropdown');

	const expandContractHamburgerButton=()=>{useExpandContractHamburgerButton(hamburgerButtonExpanded, setHamburgerButtonExpanded)};
	const expandHamburgerButton=()=>{useExpandHamburgerButton(hamburgerButtonExpanded, setHamburgerButtonExpanded)};
	const contractHamburgerButton=()=>{useContractHamburgerButton(hamburgerButtonExpanded, setHamburgerButtonExpanded)};

	const handleHamburgerClick=(e)=>{useHandleHamburgerClick(
		e,
	...
	const handleHamburgerFocus=(e)=>{useHandleHamburgerFocus(
		e,
	...
	const handleHamburgerBlur=(e)=>{useHandleHamburgerBlur(
		e,
		navDropdown,
	...
	const handleHamburgerKeyDown=(e)=>{useHandleHamburgerKeyDown(
		e,
		contractHamburgerButton,
		setNavDropdownShown,
		expandContractHamburgerButton,
	...
	const handleNavLinkBlur=(e)=>{useHandleNavLinkBlur(
		e,
		navDropdown,
		navDropdownShown,
		contractHamburgerButton,
	...
	const handleNavLinkKeyDown=(e)=>{useHandleNavLinkKeyDown(
		e,
		contractHamburgerButton,
		setNavDropdownShown,
		hamburgerButtonExpanded,
					...
					<div className='header-right'>
						...
						>
							<div className='user-button-pieces'>
								<img className='user-button-piece user-button-piece-1' src={hamburgerButtonPiece1}/>
								<img className='user-button-piece user-button-piece-2' src={hamburgerButtonPiece2}/>
								<img className='user-button-piece user-button-piece-3' src={hamburgerButtonPiece3}/>
								<img className='user-button-piece user-button-piece-4' src={hamburgerButtonPiece4}/>
								<img className='user-button-piece user-button-piece-5' src={hamburgerButtonPiece5}/>
								<img className='user-button-piece user-button-piece-6' src={hamburgerButtonPiece6}/>
							</div>
						</button>
					</div>
				</div>
			</header>
			<div className={'nav-dropdown '+(navDropdownShown?'show':'')} id='nav-dropdown'>
				...
				<Link className='nav-link' to='/' onClick={handleLogout} tabIndex='-1'>
					<button
						className='nav-link-button'

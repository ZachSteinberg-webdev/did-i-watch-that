...
export default function Header() {
	...
	const expandContractHamburgerButton = () => {
		useExpandContractHamburgerButton(hamburgerButtonExpanded, setHamburgerButtonExpanded);
	};
	const expandHamburgerButton = () => {
		useExpandHamburgerButton(hamburgerButtonExpanded, setHamburgerButtonExpanded);
	};
	const contractHamburgerButton = () => {
		useContractHamburgerButton(hamburgerButtonExpanded, setHamburgerButtonExpanded);
	};
			...
			<header className='header-container'>
				<div className='header-contents'>
					...
					<div className='header-center'>
						<p className='header-center-text'>&#x1F914; Did I Watch That?!?! &#x1F9D0;</p>
					</div>

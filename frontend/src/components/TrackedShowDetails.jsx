...
export default function TrackedShowDetails({
  ...
  const [showImageDimensions, { loading, error }] = useImageSize(
    tsd.showImageLink,
  );
  ...
  if (loading) {
                ...
                <div className="tracked-show-details-header-and-subheader-wrapper-loading">
                  <div className="tracked-show-details-header-and-subheader-container-loading">
                    ...
                    <p className="tracked-show-details-subheader-loading">
                      Premiered:{" "}
                      {(tsd.showPremiereDate &&
                        new Date(tsd.showPremiereDate).toLocaleDateString()) ||
                        "unknown"}
                    </p>
                    {tsd.showStatus && (
                        ...
                        {tsd.showAirDays.map((day, index) => {
                          return (
                            <Fragment key={index}>
                              <span>
                                {day}s
                                {index + 2 < tsd.showAirDays.length && ","}
                                {index + 1 === tsd.showAirDays.length - 1 &&
                                  " and "}
                              </span>
                              {tsd.showAirTime && (
                                <span> at {tsd.showAirTime}</span>
                              )}
                            </Fragment>
                          );
                        })}
                    ...
                    {tsd.showNetwork && (
                      <p className="tracked-show-minor-details-text-loading">
                        Airing on:{" "}
                        <a href={tsd.showNetworkWebsiteLink}>
                          {tsd.showNetwork}
                        </a>
                      </p>
                    )}
                    {tsd.showWebChannelName && (
                      <p className="tracked-show-minor-details-text-loading">
                        Shown on:{" "}
                        <a href={tsd.showWebChannelWebsiteLink}>
                          {tsd.showWebChannelName}
                        </a>
                      </p>
                    )}
                        ...
                        {tsd.showGenres.map((genre, index) => {
                          return (
                            <span key={index}>
                              ...
                              {index + 1 === tsd.showGenres.length - 1 &&
                                " and "}
                            </span>
                          );
                        })}
    ...
    showImageDimensions &&
    showImageDimensions?.height > showImageDimensions?.width
  ) {
    return (
      <>
        <div

...
const useHandleTrackedShowsListSort = async (e, setShowTrackedShowsSpinner, user, setTrackedShows, navigate) => {
	...
	try {
		...
		if (guestMode) {
			...
			const sorted = [...existing].sort((a, b) => a.showName.localeCompare(b.showName));

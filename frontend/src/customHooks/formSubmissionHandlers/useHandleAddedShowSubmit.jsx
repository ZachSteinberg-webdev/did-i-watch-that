...
const useHandleAddedShowSubmit = async (e, setTrackedShowsSpinner, user, setTrackedShows, navigate) => {
		...
		if (guestMode) {
			...
			if (existing.find((s) => s.showId === postedShowDataObject.id)) {
				...
				const show = {
					...
					showImageLink: postedShowDataObject.image && postedShowDataObject.image.original,

...
const useHandleUserChangeSubmit = async (
  ...
  try {
    ...
    if (userDetailData.data.success === true) {
      ...
      const userDetailsUpdateMessage =
        "Success! Your details have been updated.";
      toast.success(
        <Toast icon="👍" messageParagraph={userDetailsUpdateMessage} />,
        { icon: false },
      );
    }
  } catch (err) {
  ...
  try {
    ...
    if (userPasswordData.data.success === true) {
      const userPasswordUpdateMessage =
        "Success! Your password has been updated.";
      toast.success(
        <Toast icon="👍" messageParagraph={userPasswordUpdateMessage} />,
        { icon: false },
      );
    }
  } catch (err) {
